...
keep if preferencia_postulante == 1
...
di as res "Done. Tidy results are in memory: one row per {outcome, rbd_treated level}."
 ...
 save "data/clean/effects_schools_long_P1.dta", replace
 export delimited using "data/clean/effects_schools_long_P1.csv", replace
