...
STEM value added is less predictive in the second quintile and marginally less predictive in the fourth, while none of the language or institutional-quality differences relative to the middle quintile is statistically significant.
These results point to differences across some groups and outcomes, rather than a common pattern across the baseline achievement distribution.
...
\end{figure}
\input{../../output/tables/results_section/simce4_math_quintile_contrasts_vs_q3.tex}
\FloatBarrier
...
The main estimates suggest substantial pass-through.
The estimates are 0.841 for math, 0.835 for language, 0.689 for STEM enrollment, and 1.153 for institutional quality.
In practical terms, schools that observationally look better at raising achievement or higher-education outcomes also tend to have causal effects on those same outcomes.
The achievement estimates are close to comparable lottery-based estimates in \textcite{angrist_leveraging_2017}, despite the absence of immediately lagged outcomes.
This supports the use of rich pre-treatment controls for outcomes, such as higher-education choices, for which lagged measures are unavailable.

The heterogeneity results show that this relationship is not the same for all students.
...
STEM value added is less predictive in the second quintile and marginally less predictive in the fourth.
For language and institutional quality, none of the differences relative to the middle quintile is statistically significant.
These results point to differences across some groups and outcomes, rather than a common pattern across the baseline achievement distribution.

Finally, I ask whether school effects on STEM enrollment are simply achievement effects in another form.
Math and STEM value added are weakly related across schools, and the IV results show that math value added predicts math achievement but not STEM enrollment, while the part of STEM value added unrelated to math predicts STEM enrollment but not math achievement.
These results suggest that high schools differ along multiple dimensions.
In particular, schools affect higher-education decisions, such as field choice, beyond their effects on achievement.
...
Future work should identify the channels that generate these effects and examine whether families value and respond to nontraditional measures of school value added.
It should also study whether providing information on multiple dimensions of school quality changes school demand and later educational choices, and estimate the aggregate consequences of systematically ignoring these dimensions when students are allocated across schools.
